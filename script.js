...
const translations = {
  cs: {
    ...
    modalType: "Typ focení",
    modalNotes: "Poznámky",
    modalSubmit: "Odeslat rezervaci",
    selectType: "Vyberte typ",
    typePortrait: "Portrét",
    typeFamily: "Rodinné",
    typeCouple: "Párové",
    typeCommercial: "Komerční",
    typeCreative: "Kreativní",
    typeOther: "Jiné"
  },
  ru: {
    navHome: "Главная",
